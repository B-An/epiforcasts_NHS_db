...
**Related documents:** [docs/README.md](docs/README.md) (index), [USER_EXPLAINER.md](docs/USER_EXPLAINER.md), [TECHNICAL_OVERVIEW.md](docs/TECHNICAL_OVERVIEW.md), [GOVERNANCE_SENSE_CHECK.md](docs/GOVERNANCE_SENSE_CHECK.md).
...
4. **CHANGELOG.md:** For **versioned** user-visible or model-behaviour changes, add a short `CHANGELOG.md` and reference it from PRs (see `RULES_CURSOR_NHS.md` Rule 15 if you adopt that rigour).
